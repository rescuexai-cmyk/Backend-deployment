...
VALUES
  ...
  (gen_random_uuid()::text, 'delhi', 'bike_taxi', 15, 5, 0.8, 15, true, NOW(), NOW()),
  ...
  (gen_random_uuid()::text, 'gurgaon', 'bike_taxi', 15, 5, 0.8, 15, true, NOW(), NOW()),
  ...
  (gen_random_uuid()::text, 'noida', 'bike_taxi', 15, 5, 0.8, 15, true, NOW(), NOW()),
  ...
  (gen_random_uuid()::text, 'faridabad', 'bike_taxi', 15, 5, 0.8, 15, true, NOW(), NOW()),
  ...
  (gen_random_uuid()::text, 'ghaziabad', 'bike_taxi', 15, 5, 0.8, 15, true, NOW(), NOW()),
...
VALUES
  ...
  (gen_random_uuid()::text, 'bike_taxi', NULL, 2, 3, 1.0, true, NOW()),
